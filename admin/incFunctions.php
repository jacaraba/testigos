	...
	*/
	...
	function getTableList($skip_authentication = false) {
		...
		$arrTables = [
			...
			'departamentos' => ['Departamentos', 'Table imported using MySQL2AppGini on 2023-10-02', 'table.gif', 'None'],
			'divpol2022' => ['Divpol2022', 'Table imported using MySQL2AppGini on 2023-10-02', 'table.gif', 'None'],
			'divpol2022valle' => ['Divpol2022valle', 'Table imported using MySQL2AppGini on 2023-10-02', 'table.gif', 'None'],
			'divpol2022vallecali' => ['Divpol2022vallecali', 'Table imported using MySQL2AppGini on 2023-10-02', 'table.gif', 'None'],
			'jurados' => ['Jurados', 'Table imported using MySQL2AppGini on 2023-10-02', 'table.gif', 'None'],
			'municipios' => ['Municipios', 'Table imported using MySQL2AppGini on 2023-10-02', 'table.gif', 'None'],
	...
	function get_table_fields($tn = null) {
		...
		if($schema === null) {
			...
			$schema = [
				...
				'numeros' => [
					'curul' => [
						'appgini' => "INT(4) NOT NULL PRIMARY KEY",
						'info' => [
							'caption' => 'Curul',
							'description' => '',
						],
				...
				'testigospuestos' => [
					'llave' => [
						'appgini' => "INT(3) NOT NULL PRIMARY KEY AUTO_INCREMENT",
						'info' => [
							'caption' => 'Llave',
							'description' => '',
						],
				...
				'concejo2019vallecalivotos' => [
					'CVOTOS' => [
						'appgini' => "VARCHAR(31) NOT NULL PRIMARY KEY",
						'info' => [
							'caption' => 'CVOTOS',
							'description' => '',
						],
	...
	function lookupQuery($tn, $lookupField) {
		...
		*/
		$lookupQuery = [
			...
			'concejo2019vallecalivotos' => [
				'PUESTO' => 'SELECT `divpol2022vallecali`.`PUESTO`, IF(CHAR_LENGTH(`divpol2022vallecali`.`PUESTO`) || CHAR_LENGTH(`divpol2022vallecali`.`nompue`), CONCAT_WS(\'\', `divpol2022vallecali`.`PUESTO`, \' - \', `divpol2022vallecali`.`nompue`), \'\') FROM `divpol2022vallecali` ORDER BY 2',
				'PARTIDO' => 'SELECT `partidos2022`.`partido`, IF(CHAR_LENGTH(`partidos2022`.`partido`) || CHAR_LENGTH(`partidos2022`.`nompartido`), CONCAT_WS(\'\', `partidos2022`.`partido`, \' - \', `partidos2022`.`nompartido`), \'\') FROM `partidos2022` ORDER BY 2',
			],
		];
