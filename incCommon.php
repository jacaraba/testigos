	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'divpol2022valle' => "`divpol2022valle`.`PUESTO` as 'PUESTO', `divpol2022valle`.`dd` as 'dd', `divpol2022valle`.`mm` as 'mm', `divpol2022valle`.`zz` as 'zz', `divpol2022valle`.`pp` as 'pp', `divpol2022valle`.`departamento` as 'departamento', `divpol2022valle`.`municipio` as 'municipio', `divpol2022valle`.`nompue` as 'nompue', `divpol2022valle`.`direccion` as 'direccion', `divpol2022valle`.`mujeres` as 'mujeres', `divpol2022valle`.`hombres` as 'hombres', `divpol2022valle`.`total` as 'total', `divpol2022valle`.`mesas` as 'mesas', `divpol2022valle`.`comuna` as 'comuna', `divpol2022valle`.`nomcomuna` as 'nomcomuna'",
			'divpol2022vallecali' => "`divpol2022vallecali`.`PUESTO` as 'PUESTO', `divpol2022vallecali`.`dd` as 'dd', `divpol2022vallecali`.`mm` as 'mm', `divpol2022vallecali`.`zz` as 'zz', `divpol2022vallecali`.`pp` as 'pp', `divpol2022vallecali`.`departamento` as 'departamento', `divpol2022vallecali`.`municipio` as 'municipio', `divpol2022vallecali`.`nompue` as 'nompue', `divpol2022vallecali`.`direccion` as 'direccion', `divpol2022vallecali`.`mujeres` as 'mujeres', `divpol2022vallecali`.`hombres` as 'hombres', `divpol2022vallecali`.`total` as 'total', `divpol2022vallecali`.`mesas` as 'mesas', `divpol2022vallecali`.`comuna` as 'comuna', `divpol2022vallecali`.`nomcomuna` as 'nomcomuna'",
			'jurados' => "`jurados`.`PUESTO` as 'PUESTO', `jurados`.`CEDULA` as 'CEDULA', `jurados`.`NOMBRE` as 'NOMBRE', `jurados`.`CELULAR` as 'CELULAR', `jurados`.`DIRECION` as 'DIRECION', `jurados`.`CONTACTO` as 'CONTACTO'",
			'municipios' => "`municipios`.`ddmm` as 'ddmm', `municipios`.`dd` as 'dd', `municipios`.`mm` as 'mm', `municipios`.`municipio` as 'municipio'",
	...
	function get_sql_from($table_name, $skip_permissions = false, $skip_joins = false, $lower_permissions = false) {
		$sql_from = [
			...
			'divpol2022valle' => "`divpol2022valle` ",
			'divpol2022vallecali' => "`divpol2022vallecali` ",
			'jurados' => "`jurados` ",
		...
		$pkey = [
			...
			'municipios' => 'ddmm',
			'numeros' => 'curul',
			'partidos2019' => 'partido',
			'partidos2022' => 'partido',
			'testigos' => 'CEDULA',
			'testigospuestos' => 'llave',
			'concejo2019vallecalivotos' => 'CVOTOS',
		];
	...
	function NavMenus($options = []) {
		...
		if(is_array($arrTables)) {
			foreach($arrTables as $tn => $tc) {
				...
				$tChkHL = array_search($tn, ['departamentos','divpol2022','divpol2022valle','divpol2022vallecali','jurados','municipios','numeros','partidos2019','partidos2022']);

				/* ---- list of tables where filter first is set ---- */
				$tChkFF = array_search($tn, ['concejo2019vallecalivotos']);
