...
*/
	...
	$lookups = [
		...
		'concejo2019vallecalivotos' => [
			...
			'PARTIDO' => [
				'parent_table' => 'partidos2022',
				'parent_pk_field' => 'partido',
				'parent_caption' => 'IF(CHAR_LENGTH(`partidos2022`.`partido`) || CHAR_LENGTH(`partidos2022`.`nompartido`), CONCAT_WS(\'\', `partidos2022`.`partido`, \' - \', `partidos2022`.`nompartido`), \'\')',
				'parent_from' => '`partidos2022` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
